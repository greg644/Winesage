          ...
          <div style={{ padding: "20px 24px" }}>
            ...
            <div style={{ marginBottom: 24, border: "1px solid " + S.border, background: S.surface, padding: "16px 20px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                ...
                <button onClick={shareAnalysis} style={{ background: "#25D366", border: "none", borderRadius: 6, padding: "6px 12px", cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  <span style={{ color: "white", fontFamily: "monospace", fontSize: 10, fontWeight: 700, letterSpacing: "0.1em" }}>SHARE</span>
                </button>
              </div>
